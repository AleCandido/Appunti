\documentclass[10pt]{beamer}	%,handout
...
\begin{frame}
	\begin{center}
%		\vspace{-1cm}
		{\transparent{0.1}\includegraphics[scale=0.3]{./Images/logo.jpg}}
		\vspace{-8cm}
		{\transparent{0.8}\textcolor{white}{\rule{\paperwidth}{\paperheight}}}
	\end{center}
	\vspace{-9cm}
...
%	\frametitle{Ringraziamenti}
	...
	\begin{center}
		\vspace{-0.8cm}
		{\transparent{0.2}\includegraphics[scale=0.3]{./Images/cards.jpg}}
		\vspace{-8cm}
		{\transparent{0.8}\textcolor{white}{\rule{\paperwidth}{\paperheight}}}
	\end{center}
	\vspace{-5cm}	
